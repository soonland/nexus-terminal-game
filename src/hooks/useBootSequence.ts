...
const BOOT_LINES: Array<{ type: Parameters<typeof makeLine>[0]; content: string; delay: number }> = [
  ...
  { type: 'output',    content: '  Objective: classified — you will know it when you find it.', delay: 3650 },
  { type: 'output',    content: '  Handler  : DISPATCH  |  Cover: none  |  Disavowal: immediate', delay: 3800 },
  { type: 'separator', content: '', delay: 4000 },
  { type: 'system',    content: "Type 'help' to list available commands.", delay: 4150 },
]

export function useBootSequence(): { lines: TerminalLine[]; done: boolean } {
