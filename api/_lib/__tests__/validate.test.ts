...
describe('requireString', () => {
  ...
  it('should throw ValidationError when given an empty string', () => {
    expect(() => requireString('', 'prompt')).toThrow(ValidationError);
  ...
  it('should throw ValidationError when given undefined', () => {
    expect(() => requireString(undefined as unknown as string, 'field')).toThrow(ValidationError);
  });
  ...
  it('should include the field name in the error message', () => {
    expect(() => requireString('', 'mySpecialField')).toThrow(
      'Missing or empty field: mySpecialField',
    );
  });
});
...
describe('requireObject', () => {
  ...
  it('should throw ValidationError when given null', () => {
    expect(() => requireObject(null, 'Request body')).toThrow(ValidationError);
  ...
  it('should throw ValidationError when given an array', () => {
    expect(() => requireObject([], 'Request body')).toThrow(ValidationError);
  ...
  it('should throw ValidationError when given a non-empty array', () => {
    expect(() => requireObject([1, 2], 'body')).toThrow(ValidationError);
  });

  it('should throw ValidationError when given a string', () => {
    expect(() => requireObject('hello', 'Request body')).toThrow(ValidationError);
    expect(() => requireObject('hello', 'Request body')).toThrow(
      'Request body must be a JSON object',
    );
  });

  it('should throw ValidationError when given a number', () => {
    expect(() => requireObject(42, 'body')).toThrow(ValidationError);
  });

  it('should throw ValidationError when given undefined', () => {
    expect(() => requireObject(undefined, 'body')).toThrow(ValidationError);
  });
